    ...
    public function dashboardReadingMonitor(Request $request) {
        ...
        if ($day == 'All') {
            $data = DB::table('Billing_ServiceAccounts')
                ...
                ->whereNotNull('Billing_ServiceAccounts.MeterReader')
                ->select('users.name', 'users.id',
                    DB::raw("(SELECT COUNT(r.id) FROM Billing_Readings r LEFT JOIN Billing_ServiceAccounts sa ON sa.id=r.AccountNumber WHERE sa.MeterReader=CAST(users.id AS varchar) AND r.ServicePeriod='" . $period . "' AND r.AccountNumber NOT IN (SELECT AccountNumber FROM Billing_Bills WHERE ServicePeriod='" . $period . "')) AS TotalUnbilledBasedFromReadings"),
                    ...
                    DB::raw("(SELECT COUNT(r.id) FROM Billing_Readings r LEFT JOIN Billing_ServiceAccounts sa ON sa.id=r.AccountNumber WHERE r.AccountNumber IS NOT NULL AND sa.MeterReader=CAST(users.id AS varchar) AND r.ServicePeriod='" . $period . "') AS TotalReading"),
                    ...
                    DB::raw("(SELECT SUM(CAST(KwhUsed AS DECIMAL(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts sa ON sa.id=b.AccountNumber WHERE b.KwhUsed IS NOT NULL AND ISNUMERIC(b.KwhUsed)=1 AND sa.MeterReader=CAST(users.id AS varchar) AND b.ServicePeriod='" . $period . "') AS TotalKwh")
                )
                ->groupBy('users.name', 'users.id')
                ->orderBy('users.name')
                ->get();
            ...
            $data = DB::table('Billing_ServiceAccounts')
                ...
                ->select('users.name', 'users.id',
                    ...
                    DB::raw("(SELECT COUNT(r.id) FROM Billing_Readings r LEFT JOIN Billing_ServiceAccounts sa ON sa.id=r.AccountNumber WHERE sa.MeterReader=CAST(users.id AS varchar) AND sa.GroupCode='" . $day . "' AND r.ServicePeriod='" . $period . "' AND r.AccountNumber NOT IN (SELECT AccountNumber FROM Billing_Bills WHERE ServicePeriod='" . $period . "')) AS TotalUnbilledBasedFromReadings"),
                    ...
                    DB::raw("(SELECT COUNT(r.id) FROM Billing_Readings r LEFT JOIN Billing_ServiceAccounts sa ON sa.id=r.AccountNumber WHERE r.AccountNumber IS NOT NULL AND sa.GroupCode='" . $day . "' AND sa.MeterReader=CAST(users.id AS varchar) AND r.ServicePeriod='" . $period . "') AS TotalReading"),
                    ...
                    DB::raw("(SELECT SUM(CAST(KwhUsed AS DECIMAL(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts sa ON sa.id=b.AccountNumber WHERE b.KwhUsed IS NOT NULL AND ISNUMERIC(b.KwhUsed)=1 AND sa.GroupCode='" . $day . "' AND sa.MeterReader=CAST(users.id AS varchar) AND b.ServicePeriod='" . $period . "') AS TotalKwh")
                )
                ->groupBy('users.name', 'users.id')
                ->orderBy('users.name')
                ->get();
