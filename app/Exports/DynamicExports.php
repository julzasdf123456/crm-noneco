...
class DynamicExports implements FromArray, ShouldAutoSize, WithColumnFormatting, WithHeadings, WithStyles, WithEvents, WithCustomStartCell {

    private $data, $period, $town, $headers, $columnFormats, $cellStart, $styles, $title;

    public function __construct(array $data, $period, $town, $headers, $columnFormats, $cellStart, $styles, $title) {
        $this->data = $data;
        $this->period = $period;
        $this->town = $town;
    ...
    public function registerEvents(): array {
        return [
            AfterSheet::class => function(AfterSheet $event) { 
                ...
                $event->sheet->setCellValue('A6', 'BILLING MONTH: ' . ($this->period != null ? date('F Y', strtotime($this->period)) : '-'));
