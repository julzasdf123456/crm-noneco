...
Route::get('/bills/print-bulk-bill-old-format-bapa/{period}/{bapaName}', [App\Http\Controllers\BillsController::class,  'printBulkBillOldFormatBapa'])->name('bills.print-bulk-bill-old-format-bapa');
