...
if (urlX.includes('serviceConnection') | urlX.includes('memberConsumers') | urlX.includes('tickets') | urlX.includes('events')) {}
else {
setTimeout(function() {
    let timerInterval;Swal.fire({
        ...
        didOpen: () => {Swal.showLoading();
            const timer = Swal.getPopup().querySelector("b");timerInterval = setInterval(() => {}, 100);},willClose: () => {clearInterval(timerInterval);}}).then((result) => {if (result.dismiss === Swal.DismissReason.timer) {}});
