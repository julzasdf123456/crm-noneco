...
<div>
    ...
    <table style="page-break-before: always;">
        <thead>
            <tr>
                <td colspan="9" class="text-left">Generated on {{ date('m/d/Y h:i:s A') }}</td>
            </tr>
            <tr>
                <th colspan="9" class="text-center">{{ strtoupper(env('APP_COMPANY')) }}</th>
            </tr>
            <tr>
                <th colspan="9" class="text-center">{{ strtoupper(env('APP_ADDRESS')) }}</th>
            </tr>
            <tr>
                <th colspan="9" class="text-center">TURN OFF LIST FOR BILLING MONTH {{ date('F Y', strtotime($period)) }}</th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            @foreach ($list as $item)
                ...
                <tr>
                    ...
                    <td class="text-right" style="border-bottom: 1px solid #454545;">{{ $item->NetAmount != null ? number_format($item->NetAmount, 2) : "0" }}</td>
                    <td class="text-right">_________</td>
                    <td style="width: 15%;">________________</td>
                </tr>
                @php  
                    $i++;
                @endphp
