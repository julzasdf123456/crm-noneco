...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h4 style="display: inline; margin-right: 15px;">Service Connection Energization Report</h4>
            </div>
        </div>
    </div>
</section>
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="card shadow-none">
            {!! Form::open(['route' => 'serviceConnections.sevice-connections-report', 'method' => 'GET']) !!}
            <div class="card-body">
                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $('#print').on('click', function(e) {
                e.preventDefault()
                window.location.href = "{{ url('/service_connections/print-sevice-connections-report') }}" + "/" + $("#Town").val() + "/" + $("#From").val() + "/" + $("#To").val()
            })
        })
    </script>
@endpush