...
<div  class="content" style="margin: 15px;">
    <div class="row">
        ...
        @if ($memberConsumer != null)
            ...
            @if ($memberConsumer->MembershipType == MemberConsumers::getJuridicalId())
                <div class="col-sm-6">
                    ...
                    <p class="left-indent">Address: <u><strong>{{ MemberConsumers::getAddress($memberConsumer) }}</strong></u></p>
            ...
            <div class="col-sm-6">
                ...
                <p class="left-indent">Owner Address: <u><strong>{{ ServiceConnections::getAddress($serviceConnection) }}</strong></u></p>
                <p class="left-indent">Residence Cert. No: <u><strong>{{ $serviceConnection->ResidenceNumber }}</strong></u></p>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-sm-3">
            ...
            <div class="divider"></div>
            <p class="text-center">CS & MR CUSTODIAN</p>
        </div>
