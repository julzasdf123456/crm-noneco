                                ...
                                @foreach ($serviceConnections as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('serviceConnections.print-order', [$item->id]) }}" class="text-success" title="Issue and Print Energization Order/Ticket"> <i class="fas fa-print"></i> </a>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{ route('serviceConnectionMtrTrnsfrmrs.create-step-three', [$item->id]) }}" class="text-warning" title="Update Energization Order"> <i class="fas fa-pencil-alt"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach                                
                            </tbody>
