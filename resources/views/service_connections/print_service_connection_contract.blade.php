...
<div  class="content" style="margin: 15px;">
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <br>
            <p>Name/Firm:   <u><strong>{{ MemberConsumers::serializeMemberNameFormal($memberConsumer) }}</strong></u></p>
            @if ($memberConsumer->MembershipType == MemberConsumers::getJuridicalId())
                <p>Spouse/Representative:   <u><strong>{{ MemberConsumers::serializeSpouse($memberConsumer) }}</strong></u></p>
            @else
                <p>Spouse/Representative:   <u><strong>{{ $spouse != null ? ($spouse->FirstName . ' ' . $spouse->LastName . ' ' . $spouse->Suffix) : '-' }}</strong></u></p>
            @endif
            <p>Location of Installation:   <u><strong>{{ ServiceConnections::getAddress($serviceConnection) }}</strong></u></p>
        </div>
        <div class="col-sm-4">
            <p>Kind of Membership:   <u><strong>{{ $memberConsumer->Type }}</strong></u></p>
        </div>
        <div class="col-sm-4">
        ...
        @if ($memberConsumer->MembershipType == MemberConsumers::getJuridicalId())
            <div class="col-sm-4 offset-sm-4">
                <br>
                <br>
                <p class="text-center"><strong>{{ MemberConsumers::serializeSpouse($memberConsumer) }}</strong></p>
                <div class="divider"></div>
        ...
        @else
            <div class="col-sm-4 offset-sm-4">
                <br>
                <br>
                <p class="text-center"><strong>{{ MemberConsumers::serializeMemberNameFormal($memberConsumer) }}</strong></p>
                <div class="divider"></div>
                <p class="text-center">Sign Over Printed Name</p>
            </div>
