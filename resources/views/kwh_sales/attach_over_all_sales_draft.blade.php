<div class="card">
    <div class="card-header border-0">
        <span class="card-title">Overall Sales Draft</span>
    ...
    <div class="card-body table-responsive px-0">
            ...
            <tbody>
                ...
                @foreach ($allData as $item)
                    <tr>
                        ...
                        <td class="text-right">{{ number_format($item->KwhSold, 2) }}</td>
                ...
                <tr>
                    <th>GRAND TOTAL</th>
                    <td class="text-right">{{ number_format($totalConsumers) }}</td>
                    <td class="text-right">{{ number_format($totalResidentials, 2) }}</td>
                    <td class="text-right">{{ number_format($totalCommercial, 2) }}</td>
                    <td class="text-right">{{ number_format($totalWater, 2) }}</td>
                    <td class="text-right">{{ number_format($totalIndustrial, 2) }}</td>
                    <td class="text-right">{{ number_format($totalPub, 2) }}</td>
                    <td class="text-right">{{ number_format($totalStLights, 2) }}</td>
                    <td class="text-right">{{ number_format($totalKwhSold, 2) }}</td>
                    <td class="text-right">{{ number_format($totalAmnt, 2) }}</td>
                    <td class="text-right">{{ number_format($totalMisionary, 2) }}</td>
                    <td class="text-right">{{ number_format($totalEnv, 2) }}<br>{{ number_format($totalNpc, 2) }}</td>
                    <td class="text-right">{{ number_format($totalStranded, 2) }}<br>{{ number_format($totalRedci, 2) }}</td>
                    <td class="text-right">-<br>{{ number_format($totalFitAll, 2) }}</td>
                    <td class="text-right">{{ number_format($totalRpt, 2) }}<br>-</td>
                    <td class="text-right">{{ number_format($totalVat, 2) }}</td>
                    <td class="text-right">{{ number_format($totalScSub, 2) }}<br>{{ number_format($totalScDisc, 2) }}</td>
                    <td class="text-right"></td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="row">
            ...
            @else
                <p><i>Sales Distribution Loss Report Not Yet Generated.</i></p>
            @endif                    
        </div>
    </div>
</div>