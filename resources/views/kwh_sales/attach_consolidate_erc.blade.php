        ...
        <tr>
            @php
                $generationSystem = DB::table('Billing_Rates')
                    ->select(
                        DB::raw("(SELECT SUM(TRY_CAST(GenerationSystemCharge AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS Residential"),
                        DB::raw("(SELECT SUM(TRY_CAST(GenerationSystemCharge AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'STREET LIGHTS', 'IRRIGATION/WATER SYSTEMS')) AS LowVoltage"),
        ...
        <tr>
            @php
                $franchise = DB::table('Billing_Rates')
                    ->select(
                        DB::raw("(SELECT SUM(TRY_CAST(FranchiseTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS Residential"),
                        DB::raw("(SELECT SUM(TRY_CAST(FranchiseTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'STREET LIGHTS', 'IRRIGATION/WATER SYSTEMS')) AS LowVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(FranchiseTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL HIGH VOLTAGE', 'INDUSTRIAL HIGH VOLTAGE', 'PUBLIC BUILDING HIGH VOLTAGE')) AS HighVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(FranchiseTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "') AS TotalAmount")                  
                    )
                    ->limit(1)
                    ->first();
            @endphp
        ...
        <tr>
            @php
                $business = DB::table('Billing_Rates')
                    ->select(
                        DB::raw("(SELECT SUM(TRY_CAST(BusinessTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS Residential"),
                        DB::raw("(SELECT SUM(TRY_CAST(BusinessTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'STREET LIGHTS', 'IRRIGATION/WATER SYSTEMS')) AS LowVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(BusinessTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL HIGH VOLTAGE', 'INDUSTRIAL HIGH VOLTAGE', 'PUBLIC BUILDING HIGH VOLTAGE')) AS HighVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(BusinessTax AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "') AS TotalAmount")                  
                    )
                    ->limit(1)
                    ->first();
            @endphp
        ...
        <tr>
            @php
                $scDisc = DB::table('Billing_Rates')
                    ->select(
                        DB::raw("(SELECT SUM(TRY_CAST(SeniorCitizenSubsidy AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND TRY_CAST(SeniorCitizenSubsidy AS decimal(10,2)) < 0 AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS Residential"),
                        DB::raw("(SELECT SUM(TRY_CAST(SeniorCitizenSubsidy AS decimal(10,2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND TRY_CAST(SeniorCitizenSubsidy AS decimal(10,2)) < 0 AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'STREET LIGHTS', 'IRRIGATION/WATER SYSTEMS')) AS LowVoltage"),
        ...
        <tr>
            @php
                $residentialTtl = DB::table('Billing_Bills')
                                    ...
                                    ->whereRaw("Town IS NOT NULL AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL') AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "'")
                                    ->select(
                ...
                $lowVoltTtl = DB::table('Billing_Bills')
                                    ->leftJoin('Billing_ServiceAccounts', 'Billing_Bills.AccountNumber', '=', 'Billing_ServiceAccounts.id')
                                    ->whereRaw("Town IS NOT NULL AND ConsumerType IN ('PUBLIC BUILDING', 'STREET LIGHTS', 'INDUSTRIAL', 'IRRIGATION/WATER SYSTEMS', 'COMMERCIAL') AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "'")
                                    ->select(
                                        DB::raw("SUM(TRY_CAST(NetAmount AS DECIMAL(12,2))) AS NetAmount"),
                                    )
                                    ->first();
                ...
                $highVoltTtl = DB::table('Billing_Bills')
                                    ->leftJoin('Billing_ServiceAccounts', 'Billing_Bills.AccountNumber', '=', 'Billing_ServiceAccounts.id')
                                    ->whereRaw("Town IS NOT NULL AND ConsumerType IN ('PUBLIC BUILDING HIGH VOLTAGE', 'INDUSTRIAL HIGH VOLTAGE', 'COMMERCIAL HIGH VOLTAGE') AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "'")
                                    ->select(
                                        DB::raw("SUM(TRY_CAST(NetAmount AS DECIMAL(12,2))) AS NetAmount"),
                                    )
                                    ->first();
                ...
                $grandTtl = DB::table('Billing_Bills')
                                ->leftJoin('Billing_ServiceAccounts', 'Billing_Bills.AccountNumber', '=', 'Billing_ServiceAccounts.id')
                                ->whereRaw("Town IS NOT NULL AND ServicePeriod='" . $period . "' AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM'))")
                                ->select(
                                    DB::raw("SUM(TRY_CAST(NetAmount AS DECIMAL(12,2))) AS NetAmount"),
                                )
                                ->first();
        ...
        <tr>
            @php
                $totalQry = DB::table("Billing_Bills")
                    ->select(
                        DB::raw("(SELECT SUM(TRY_CAST(KwhUsed AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS TotalResidential"),
                        DB::raw("(SELECT SUM(TRY_CAST(KwhUsed AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'IRRIGATION/WATER SYSTEMS', 'STREET LIGHTS')) AS TotalLowVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(KwhUsed AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL HIGH VOLTAGE', 'INDUSTRIAL HIGH VOLTAGE', 'PUBLIC BUILDING HIGH VOLTAGE')) AS TotalHighVoltage"),
                        DB::raw("(SELECT SUM(TRY_CAST(KwhUsed AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "') AS Total"),
                        DB::raw("(SELECT SUM(TRY_CAST(DemandPresentKwh AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('RESIDENTIAL', 'RURAL RESIDENTIAL')) AS ResidentialCount"),
                        DB::raw("(SELECT SUM(TRY_CAST(DemandPresentKwh AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL', 'INDUSTRIAL', 'PUBLIC BUILDING', 'IRRIGATION/WATER SYSTEMS', 'STREET LIGHTS')) AS LowVoltageCount"),
                        DB::raw("(SELECT SUM(TRY_CAST(DemandPresentKwh AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "' AND ConsumerType IN ('COMMERCIAL HIGH VOLTAGE', 'INDUSTRIAL HIGH VOLTAGE', 'PUBLIC BUILDING HIGH VOLTAGE')) AS HighVoltageCount"),
                        DB::raw("(SELECT SUM(TRY_CAST(DemandPresentKwh AS decimal(10, 2))) FROM Billing_Bills b LEFT JOIN Billing_ServiceAccounts a ON b.AccountNumber=a.id WHERE a.Town IS NOT NULL AND (AdjustmentType IS NULL OR AdjustmentType NOT IN ('DM/CM')) AND ServicePeriod='" . $period . "') AS TotalCount")
                    )
                    ->limit(1)
                    ->first();
            @endphp
