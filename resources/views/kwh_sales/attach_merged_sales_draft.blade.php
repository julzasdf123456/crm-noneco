<div class="card">
    <div class="card-header border-0">
        <span class="card-title">Merged Sales Draft (Merged Low Voltage and High Voltage)</span>
        ...
        <table class="table table-sm table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($totalLowVoltage, 2) }}</td>
                    <td class="text-right">{{ number_format($totalHighVoltage, 2) }}</td>
