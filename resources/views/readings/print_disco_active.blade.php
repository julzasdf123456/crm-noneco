...
<div id="print-area" class="content">
    ...
    <p class="text-center"><strong>DISCO/ACTIVE</strong> READINGS REPORT FOR {{ date('F Y', strtotime($period)) }}</p>
    <br> 
    ...
    <table style="width: 100%;">
        <thead>
            ...
            <th class="text-right" style="border-bottom: 1px solid #454455">KwhUsed</th>
            <th class="text-right" style="border-bottom: 1px solid #454455">Amount</th>
