                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if ($meterReader != null)
                            ...
                            <a class="btn btn-xs btn-default" href="{{ route('readings.print-new-format-adjusted', [$period, $day, $town, $meterReader->id]) }}" title="Print All Stuck Ups" style="margin-right: 2px;"><i class="fas fa-print"></i> Others</a>
                        @else
