                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-3">
                            ...
                            <select name="BAPAName" id="BAPAName" class="custom-select select2">
    ...
    <script>
        $(document).ready(function() {
            $('#printBtnReport').on('click', function(e) {
                e.preventDefault()
                window.location.href = "{{ url('/readings/print-billed-unbilled-bapa') }}" + "/" + $('#Type').val() + "/" + encodeURI($('#BAPAName').val()) + "/" + $('#ServicePeriod').val() + "/" + $('#AccountStatus').val()
            })
        })
    </script>
@endpush