...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Excemptions Report Per Meter Reader</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card shadow-none">
                <div class="card-body">
                    {!! Form::open(['route' => 'readings.excemptions-per-mreader', 'method' => 'GET']) !!}
                    <div class="row">
    ...
    <script>
        $(document).ready(function() {
            $('#printBtnReport').on('click', function(e) {
                e.preventDefault()
                window.location.href = "{{ url('/readings/print-excemptions-per-mreader') }}" + "/"  + $('#ServicePeriod').val() + "/" +  $('#MeterReader').val()
            })
        })
    </script>
@endpush