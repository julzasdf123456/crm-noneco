...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>Add Routes to BAPA ({{ urldecode($bapaName) }})</h4>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="card-body table-responsive">
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" id="BAPAName" class="form-control" placeholder="Input BAPA Name" value="{{ urldecode($bapaName) }}" readonly=true>
                    </div>
                    <div class="form-group col-lg-6">
...
@push('page_scripts')
    <script>
        ...
        function getRoutes(town) {
            ...
            $.ajax({
                url : '/service_accounts/get-routes-from-district',
                type : 'GET',
                data : {
                    Town : town
                },
