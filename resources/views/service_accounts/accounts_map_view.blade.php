...
@push('page_scripts')
    ...
    <script>
        ...
        function searchByTown(areaCode) {
            $.ajax({
                url : '/service_accounts/get-accounts-by-town',
                type : 'GET',
                data : {
                    Town : areaCode,
                },
                success : function(res) {
                    ...
                    $.each(res, function(index, element) {
                        ...
                        el.innerHTML += '<button id="update" class="btn btn-sm" style="margin-left: -10px;" style="margin-left: 10px;"> <span><i class="fas fa-info-circle text-info"></i></span> </button>'
