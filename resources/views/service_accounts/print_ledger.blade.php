        ...
        <tbody>
            ...
            @foreach ($ledgers as $item)
                <tr>
                    ...
                    <td class="text-right">{{ $item->ORAmount != null ?  number_format($item->ORAmount, 2) : ''}}</td>
                    <td class="text-right">{{ $item->ORNumber }}</td>
                    <td class="text-right">{{ date('m/d/Y', strtotime($item->ORDate)) }}</td>
                    <td class="text-right">{{ $item->ORAmount != null ? number_format($item->ORAmount, 2) : '' }}</td>
                    <td class="text-right">{{ $item->OfficeTransacted }}</td>
