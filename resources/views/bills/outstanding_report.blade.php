...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>All Outstanding Accounts</h4>
            </div>

            <div class="col-sm-6">
                <a href="{{ route('bills.outstanding-report-bapa') }}" class="btn btn-sm btn-danger float-right" style="margin-left: 10px;">Outstanding Per BAPA</a>
                <a href="{{ route('bills.outstanding-report-mreader') }}" class="btn btn-sm btn-info float-right">Outstanding Per Meter Reader</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="col-lg-12">
        <div class="card shadow-none p-0">
            <div class="card-body px-4 py-1">
                <form id="form-submit" action="{{ route('bills.outstanding-report') }}" method="GET">
                    <div class="row">
        ...
        $(document).ready(function() {
            ...
            $('#download').on('click', function(e) {
                ...
                if (jQuery.isEmptyObject($('#AsOf').val())) {
                    ...
                    window.location.href = "{{ url('/bills/download-outstanding-report') }}" + "/" + $('#AsOf').val() + "/" + $('#Town').val() + "/" + $('#Status').val()
                }
            })
