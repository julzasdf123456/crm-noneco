    ...
    <div class="col-lg-12">
        <div class="card shadow-none p-0">
            <div class="card-body px-4 py-1">
                <form id="form-submit" action="{{ route('bills.outstanding-report-bapa') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <select name="BAPA" id="BAPA" class="form-control form-control-sm">
        ...
        $(document).ready(function() {
            ...
            $('#download').on('click', function(e) {
                ...
                if (jQuery.isEmptyObject($('#AsOf').val())) {
                    ...
                    window.location.href = "{{ url('/bills/download-outstanding-report-bapa') }}" + "/" + $('#AsOf').val() + "/" + encodeURIComponent($('#BAPA').val()) + "/" + $('#Status').val()
                }
            })
