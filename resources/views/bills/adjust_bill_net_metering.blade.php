        ...
        <div class="card shadow-none">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="submit" class="btn btn-primary btn-sm">Save and Proceed</button>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-lg-3">
                        <label for="PreviousKwh">Previous Import</label>
                    ...
                    <div class="form-group col-lg-3">
                        <label for="PresentKwh">Present Import</label>
                    ...
                    <div class="form-group col-lg-3">
                        <label for="KwhUsed">Import Kwh Used</label>
                    ...
                    {{-- NET METERING --}}
                    <div class="form-group col-lg-3">
                        <label for="SolarExportPrevious">Previous Export</label>
                        <input type="number" step="any" name="SolarExportPrevious" id="SolarExportPrevious" value="{{ $bill->SolarExportPrevious }}" class="form-control form-control-sm text-right">
                    </div>

                    <div class="form-group col-lg-3">
                        <label for="SolarExportPresent">Present Export</label>
                        <input type="number" step="any" name="SolarExportPresent" id="SolarExportPresent" value="{{ $bill->SolarExportPresent }}" class="form-control form-control-sm text-right">
                    </div>

                    <div class="form-group col-lg-3">
                        <label for="SolarExportKwh">Export Kwh Used</label>
                        <input type="number" step="any" name="SolarExportKwh" id="SolarExportKwh" value="{{ $bill->SolarExportKwh }}" class="form-control form-control-sm text-right">
                        {{-- <input type="number" step="any" name="KwhUsedProxy" id="KwhUsedProxy" value="{{ floatval($bill->KwhUsed) * floatval($bill->Multiplier) }}" class="form-control form-control-sm text-right"> --}}
                    </div>
                ...
                <table class="table table-sm table-borderless">
                    ...
                    <tr>
                        <th>Generation Charge (Net Export)</th>
                        <td></td>
                        <td></td>
                        <td>
                            <input type="text" name="GenerationChargeSolarExport" value="{{ $bill->GenerationChargeSolarExport }}" id="GenerationChargeSolarExport" class="form-control form-control-sm text-right" readonly="true" step="any" style="font-size: 1.2em; font-weight: bold; color: red;">
                        </td>
                    </tr>
                    <tr>
                        <th>Residual Credit Earned in Prior Months</th>
                        <td></td>
                        <td></td>
                        <td>
                            <input type="text" name="SolarResidualCredit" value="{{ $bill->SolarResidualCredit }}" id="SolarResidualCredit" class="form-control form-control-sm text-right" readonly="true" step="any" style="font-size: 1.2em; font-weight: bold; color: #00968b;">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->MissionaryElectrificationCharge }}"  name="MissionaryElectrificationCharge" id="MissionaryElectrificationCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->TransmissionDeliveryChargeKW }}"  name="TransmissionDeliveryChargeKW" id="TransmissionDeliveryChargeKW" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="EnvironmentalCharge">Environmental Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->EnvironmentalCharge }}"  name="EnvironmentalCharge" id="EnvironmentalCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->StrandedContractCosts }}"  name="StrandedContractCosts" id="StrandedContractCosts" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->OtherGenerationRateAdjustment }}"  name="OtherGenerationRateAdjustment" id="OtherGenerationRateAdjustment" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="FeedInTariffAllowance">Feed-In Tariff All.</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->FeedInTariffAllowance }}"  name="FeedInTariffAllowance" id="FeedInTariffAllowance" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->OtherTransmissionCostAdjustmentKW }}"  name="OtherTransmissionCostAdjustmentKW" id="OtherTransmissionCostAdjustmentKW" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->OtherTransmissionCostAdjustmentKWH }}"  name="OtherTransmissionCostAdjustmentKWH" id="OtherTransmissionCostAdjustmentKWH" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->OtherSystemLossCostAdjustment }}"  name="OtherSystemLossCostAdjustment" id="OtherSystemLossCostAdjustment" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->SupplySystemCharge }}"  name="SupplySystemCharge" id="SupplySystemCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="BusinessTax">Business Tax</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->BusinessTax }}"  name="BusinessTax" id="BusinessTax" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->RealPropertyTax }}"  name="RealPropertyTax" id="RealPropertyTax" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->RFSC }}"  name="RFSC" id="RFSC" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->PPARefund }}"  name="PPARefund" id="PPARefund" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="any" value="{{ $bill->OtherLifelineRateCostAdjustment }}"  name="OtherLifelineRateCostAdjustment" id="OtherLifelineRateCostAdjustment" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="SeniorCitizenDiscountAndSubsidyAdjustment">Sen. Citizen Discount & Subsidy Adj.</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SeniorCitizenDiscountAndSubsidyAdjustment }}"  name="SeniorCitizenDiscountAndSubsidyAdjustment" id="SeniorCitizenDiscountAndSubsidyAdjustment" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <label for="SolarDemandChargeKW">Export Dist. Demand  Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarDemandChargeKW }}"  name="SolarDemandChargeKW" id="SolarDemandChargeKW" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="SolarDemandChargeKWH">Export Dist. System Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarDemandChargeKWH }}"  name="SolarDemandChargeKWH" id="SolarDemandChargeKWH" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="SolarRetailCustomerCharge">Export Sup. Retail Cust. Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarRetailCustomerCharge }}"  name="SolarRetailCustomerCharge" id="SolarRetailCustomerCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="SolarSupplySystemCharge">Export Supply Sys. Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarSupplySystemCharge }}"  name="SolarSupplySystemCharge" id="SolarSupplySystemCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="SolarMeteringRetailCharge">Export Met. Retail Cust. Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarMeteringRetailCharge }}"  name="SolarMeteringRetailCharge" id="SolarMeteringRetailCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="SolarMeteringSystemCharge">Export Metering Sys. Charge</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->SolarMeteringSystemCharge }}"  name="SolarMeteringSystemCharge" id="SolarMeteringSystemCharge" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Item1">Amount DU to Customer</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->Item1 }}"  name="Item1" id="Item1" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                        <td>
                            <label for="Item4">Amount Customer to DU</label>
                        </td>
                        <td>
                            <input type="number" step="any" value="{{ $bill->Item4 }}"  name="Item4" id="Item4" class="form-control form-control-sm text-right" readonly="true">
                        </td>
                    </tr>
                </table>
            </div>
            <div class="card-footer">
                <button type="submit" class="btn btn-primary btn-sm float-right">Save and Proceed</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#KwhUsed').keyup(function() {
                adjustBill(this.value, $('#AdditionalCharges').val(), $('#Deductions').val(), is2307Checked, $('#SolarExportKwh').val())
            })
            ...
            // NET METERING
            $('#SolarExportKwh').keyup(function() {
                adjustBill($('#KwhUsed').val(), $('#AdditionalCharges').val(), $('#Deductions').val(), is2307Checked, this.value)
            })

            $('#SolarExportKwh').on('change', function() {
                adjustBill($('#KwhUsed').val(), $('#AdditionalCharges').val(), $('#Deductions').val(), is2307Checked, this.value)
            })

            $('#DemandPresentKwh').keyup(function() {
                adjustBill($('#KwhUsed').val(), $('#AdditionalCharges').val(), $('#Deductions').val(), is2307Checked, $('#SolarExportKwh').val())
            })

            $('#AdditionalCharges').keyup(function() {
                adjustBill($('#KwhUsed').val(), this.value, $('#Deductions').val(), is2307Checked, $('#SolarExportKwh').val())
            })
            ...
            $('#Deductions').keyup(function() {
                adjustBill($('#KwhUsed').val(), $('#AdditionalCharges').val(), this.value, is2307Checked, $('#SolarExportKwh').val())
            })
            ...
            // NET METERING
            $('#SolarExportPresent').keyup(function() {
                computeExportKwhUsed()
            })

            $('#SolarExportPrevious').keyup(function() {
                computeExportKwhUsed()
            })
        })
        ...
        // NET METERING
        function computeExportKwhUsed() {
            var pres = parseFloat($('#SolarExportPresent').val())
            var prev = parseFloat($('#SolarExportPrevious').val())
            var dif = pres - prev
            dif = parseFloat($('#Multiplier').val()) * dif

            // $('#KwhUsedProxy').val(parseFloat(kwhFinal).toFixed(2)).change()   
            $('#SolarExportKwh').val(parseFloat(dif).toFixed(2)).change()          
        }

        function adjustBill(kwh, additionalCharges, deductions, is2307, exportKwh) {
            $.ajax({
                    url : '{{ route("bills.fetch-net-metering-bill-adjustment-data") }}',
                    type : 'GET',
                    data : {
                        BillId : "{{ $bill->id }}",
                    ...
                    success : function(res) {
                        ...
                        $('#GenerationChargeSolarExport').val(res['GenerationChargeSolarExport'])
                        $('#SolarResidualCredit').val(res['SolarResidualCredit'])
                        $('#SolarDemandChargeKW').val(res['SolarDemandChargeKW'])
                        $('#SolarDemandChargeKWH').val(res['SolarDemandChargeKWH'])
                        $('#SolarRetailCustomerCharge').val(res['SolarRetailCustomerCharge'])
                        $('#SolarSupplySystemCharge').val(res['SolarSupplySystemCharge'])
                        $('#SolarMeteringRetailCharge').val(res['SolarMeteringRetailCharge'])
                        $('#SolarMeteringSystemCharge').val(res['SolarMeteringSystemCharge'])
                        $('#Item1').val(res['Item1'])
                        $('#Item4').val(res['Item4'])
                    },
