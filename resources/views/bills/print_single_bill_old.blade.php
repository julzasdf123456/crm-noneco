...
<div id="print-area" class="content">
    ...
    <div style="display: inline-table; width: 11%;">  
        ...
        <p style="text-align: right; margin-top: 5px; ">{{ number_format(Bills::getFinalPenalty($bills), 2) }}</p>
        <p style="text-align: right; margin-top: 5px; ">{{ number_format(floatval(Bills::getFinalPenalty($bills)) + floatval($bills->NetAmount), 2)  }}</span>
        <p style="text-align: right; margin-top: 15px; ">{{ number_format(floatval(Bills::getFinalPenalty($bills)) + floatval($bills->NetAmount), 2)  }}</span>
        @php
            $totalArr = 0.0;
            if ($arrears != null) {
