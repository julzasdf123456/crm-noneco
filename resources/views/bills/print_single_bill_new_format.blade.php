    ...
    <div class="half" style="float-right; margin-left: 5px;">
        <table class="bordered" style="width: 100%;">
            ...
            <tr>
                ...
                <th class="text-center">{{ floatval($bills->KwhUsed) * floatval($bills->Multiplier) }}</th>
            </tr>
            <tr>
        ...
        <table class="bordered" style="width: 100%; margin-top: 2px;">
            ...
            <tr class="no-border-top-bottom">
                ...
                <td class="no-border-top-bottom text-right"></td>
                <th class="no-border-top-bottom text-right">{{ Bills::getAccountTypeByType($bills->ConsumerType) != 'RESIDENTIAL' ? number_format(Bills::getFinalPenalty($bills), 2) : '0' }}</th>
            </tr>
            <tr class="no-border-top-bottom">
                <td class="no-border-top-bottom text-left" style="opacity: 0"> a</td>
                <td class="no-border-top-bottom text-right"></td>
            ...
            <tr class="no-border-top-bottom">
                ...
                <td class="no-border-top-bottom text-right"></td>
                <th class="no-border-top-bottom text-right">{{ Bills::getAccountTypeByType($bills->ConsumerType) != 'RESIDENTIAL' ? number_format(floatval(Bills::getFinalPenalty($bills)) + floatval($bills->NetAmount), 2) : number_format($bills->NetAmount, 2) }}</th>
            </tr>
        </table>
    </div>
    ...
    <div class="half" style="float-right; margin-left: 5px;">
        <table class="bordered" style="width: 100%;">
            ...
            <tr class="no-border-top-bottom">
                ...
                <th class="no-border-top-bottom text-right">{{ $arrears != null ? count($arrears) : "0" }}</th>
            </tr>
            <tr class="no-border-top-bottom">
